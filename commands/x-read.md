...
5. If the user asks to save: write an AI-first note to `Research/X-reads/YYYY-MM-DD — <slug>.md` in the vault, following the AI-first vault rule (Section 0 of `_AGENTS.md`):
   ...
   - Body starts with **For future agent:** preamble (2-3 sentences summarizing what this post is about and why it was saved)
