...
Before writing, choose the right command: use `/obsidian-save` for operational memory or broad vault updates; use `/obsidian-distill` only when conversation content should become reusable knowledge, artifacts, source-grounded notes, or finished outputs.
